...
涵盖自动化、电子信息、计算机网络及部分通识类课程的学习笔记与实验报告。

<div class="grid cards" markdown>

-   :material-robot-industrial:{ .lg .middle } __自动化与检测技术__{.middle}
...
-   :material-access-point-network:{ .lg .middle } __计算机与通信技术__{.middle}
    ...
    ---
    -   [:material-calculator-variant: Matlab 入门学习](matlab-study.md)
    -   [:material-lan: 计算机网络复习笔记](计算机网络复习笔记.md)
    -   [:material-waveform: 通信原理学习笔记](通信原理学习笔记.md)
    -   [:material-flask: 通信原理实验报告](通信原理实验报告.md)

-   :material-tools:{ .lg .middle } __课程设计与实战__{.middle}
