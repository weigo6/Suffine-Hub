...
本文内容是本科期间参加西门子杯，记录存档的设计方案模板，主要内容涉及ModebusRTU工控板的设计与制作。
...
本文是对自己参赛的一个记录。以下仓库分享了硬件设计文件（嘉立创EDA专业版文件），可作参考。
...
![image-20240629192209967](2024西门子杯参赛记录.assets/image-20240629192209967.png)
...
1.核心板设计
   ...
   ![image-20240629192820897](2024西门子杯参赛记录.assets/image-20240629192820897.png)
   ...
   指示灯方面，设置了3V3芯片电源供电指示灯和程序控制灯（连接单片机PC13引脚），便于检查核心板工作状态。![image-20240629195712887](2024西门子杯参赛记录.assets/image-20240629195712887.png)

2.接口板设计

   接口板原理图如下

   ![image-20240629194131664](2024西门子杯参赛记录.assets/image-20240629194131664.png)
   ...
   ![image-20240629195633414](2024西门子杯参赛记录.assets/image-20240629195633414.png)

3.数字量板设计

   数字量板原理图设计如下：

   ![image-20240629195839079](2024西门子杯参赛记录.assets/image-20240629195839079.png)

   ![image-20240629195917318](2024西门子杯参赛记录.assets/image-20240629195917318.png)

   ![image-20240629200000090](2024西门子杯参赛记录.assets/image-20240629200000090.png)
   ...
   ![image-20240630170902548](2024西门子杯参赛记录.assets/image-20240630170902548.png)
